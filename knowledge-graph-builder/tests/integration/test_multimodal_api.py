...
def _make_client(user_id: str = TEST_USER_ID, graph_owner_id: str = TEST_USER_ID):
    ...
    When `graph_owner_id != user_id` the verify_graph_access mock raises 403.
    """
    ...
    async def _mock_verify(gid: str, level: str, uid: str) -> str:
    ...
    app.dependency_overrides[verify_graph_access] = _mock_verify

...
class AdvancedGraphRAGPipeline:
    ...
    async def create_retrieval_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"✅ Created {retrieval_system['retrievers_created']} retrieval strategies")
    ...
    async def run_benchmarks(self) -> Dict[str, Any]:
        ...
        try:
            if self.embedder:
                ...
                test_embedding = self.embedder.embed_query("artificial intelligence research")
...
async def main():
    ...
    config = AdvancedPipelineConfig(
        ...
        openai_api_key=os.getenv("OPENAI_API_KEY", "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"),

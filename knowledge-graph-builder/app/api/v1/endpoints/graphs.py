...
from app.core.dependencies import get_neo4j_async_driver, get_neo4j_driver
...
async def create_graph(
    ...
    sync_driver: Driver = Depends(get_neo4j_driver),
):
    """
    ...
    try:
        ...
        graph_service = GraphNodeService(sync_driver)

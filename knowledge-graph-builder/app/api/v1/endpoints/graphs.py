...
@router.delete(
    ...
    responses={
        403: {"description": "Graph belongs to another user or access denied"},
        404: {"description": "Graph not found"},
        503: {"description": "Neo4j service unavailable"},
    },
)
async def delete_graph(
    ...
    Ownership is verified via ReBAC before deletion — admin-level access is
    required.  Returns `204 No Content` on success.
    """
    # ReBAC check — admin level required to delete a graph

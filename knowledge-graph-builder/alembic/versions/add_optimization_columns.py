...
def upgrade():
    ...
    op.add_column('knowledge_graphs', sa.Column('similarity_relationships', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('knowledge_graphs', sa.Column('communities_count', sa.Integer(), nullable=False, server_default='0'))

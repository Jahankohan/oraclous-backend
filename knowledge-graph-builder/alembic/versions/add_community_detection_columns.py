...
def upgrade():
    op.add_column('knowledge_graphs', sa.Column(
        'communities_detected_at', sa.DateTime(timezone=True), nullable=True
    ))
    op.add_column('knowledge_graphs', sa.Column(
        'communities_status', sa.String(20), nullable=True, server_default='not_detected'
    ))
    op.add_column('knowledge_graphs', sa.Column(
        'entity_count_at_detection', sa.Integer(), nullable=False, server_default='0'
    ))
    op.add_column('knowledge_graphs', sa.Column(
        'entity_delta_since_detection', sa.Integer(), nullable=False, server_default='0'
    ))

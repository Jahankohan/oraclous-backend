...
def test_background_job_integration():
    ...
    try:
        # Get the source code instead of executing to avoid dependencies
        with open(
            "/Users/reza/workspace/Oraclous/oraclous-data-studio/knowledge-graph-builder/app/services/background_jobs.py",
            "r",
        ) as f:
            source_code = f.read()
...
def test_database_schema_readiness():
    ...
    schema_script_path = (
        "/Users/reza/workspace/Oraclous/oraclous-data-studio/setup_community_schema.py"
    )
...
def test_community_logic():
    ...
    logic_test_path = (
        "/Users/reza/workspace/Oraclous/oraclous-data-studio/test_community_logic.py"
    )
    ...
    if os.path.exists(logic_test_path):
        ...
        try:
            result = subprocess.run(
                ["python3", logic_test_path],
                capture_output=True,
                text=True,
                cwd="/Users/reza/workspace/Oraclous/oraclous-data-studio",
            )

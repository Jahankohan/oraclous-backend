...
with open('/Users/reza/workspace/Oraclous/oraclous-data-studio/knowledge-graph-builder/app/services/chat_service.py', 'r') as f:
    content = f.read()
...
with open('/Users/reza/workspace/Oraclous/oraclous-data-studio/knowledge-graph-builder/app/services/chat_service.py', 'w') as f:
    f.write(new_content)
